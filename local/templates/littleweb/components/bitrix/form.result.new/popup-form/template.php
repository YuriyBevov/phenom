...
<div class="popup-form">
	...
	<? if ($arResult["FORM_NOTE"]): ?>
		<div class="popup-form__note">
			<span class="popup-form__title">Заявка отправлена успешно!</span>
			<p>Спасибо, мы скоро свяжемся с Вами!</p>
		</div>
	<? else: ?>

		<span class="popup-form__title"><?= $arResult["FORM_TITLE"] ?></span>
		<span class="popup-form__text"><?= $arResult["FORM_DESCRIPTION"] ?></span>
