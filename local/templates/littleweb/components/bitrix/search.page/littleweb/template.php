...
<section class="section search-page">
	<div class="container">
		...
		<form action="" method="get">
			...
			<? else: ?>
				<div class="main-input-wrapper search-row">
					<label class="">
						<input type="text" name="q" value="<?= $arResult['REQUEST']['QUERY'] ?>" size="40" placeholder="Поиск" />
					</label>
					<button class="main-btn" name="s" type="submit" aria-label="Поиск">
			...
			<ul class="search-page__list">
				<? foreach ($arResult['SEARCH'] as $arItem): ?>
					<li class="search-page__list-item">
						...
						<? if ($arItem['BODY_FORMATED'] !== $arItem['TITLE_FORMATED'] && $arItem['BODY_FORMATED'] !== ""): ?>
