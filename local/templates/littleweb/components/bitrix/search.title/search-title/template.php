	...
	<div id="<?= $CONTAINER_ID ?>" class="search-title">
		<form action="<?= $arResult['FORM_ACTION'] ?>">
			<div class="main-input-wrapper search-title__wrapper">
				...
				<button class="main-btn search-title__btn" name="s" type="submit" aria-label="Поиск">
					<svg width="24" height="24" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false">
						<use xlink:href="<?= SITE_TEMPLATE_PATH ?>/_dist/sprite.svg#icon-search"></use>
					</svg>
				</button>
			</div>
			<button type="button" class="main-btn search-title-closer" aria-label="Закрыть поиск">
				<svg width="24" height="24" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false">
